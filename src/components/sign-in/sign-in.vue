      ...
      <div id="phone">
        ...
        <div id="content-wrapper">
          ...
          <div :class="{'card': true, 'hidden': isLoginVisible}" id="register">
            <form @submit.prevent="handleRegister" @submit="onFormSubmit">
              <h1>Sign up</h1>
              ...
              <span class="checkbox remember">
                <input type="checkbox" id="terms" v-model="acceptTerms" @change="onTermsChange">
...
import {tryLogin, tryRegister} from '../../util/auth/auth.service';
